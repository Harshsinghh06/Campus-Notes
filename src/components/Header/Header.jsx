        ...
        <Container>
            <nav className='flex justify-between'>
                ...
                <div  className='flex justify-end items-center gap-2'>
                    <button key='about' onClick={()=>navigate("/all-dept")} className=' bg-blue-600 text-lg font-medium text-white px-5 py-2 duration-200 hover:bg-blue-100 rounded-full'> About Us </button>
